...
import { getMockCategories, fetchTasksFromSupabase, saveTaskToSupabase } from '@/lib/helpers';
import { getCategoryColor as getCategoryColorFromConstants, MONTHS_TR } from '@/lib/constants';
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#f6f6f8]">
      <main className="flex-1 flex flex-col overflow-hidden min-w-0 bg-[#f6f6f8]">
        ...
        <header className="bg-white px-4 md:px-6 py-3 border-b border-slate-200 flex items-center justify-between gap-3 flex-shrink-0">
