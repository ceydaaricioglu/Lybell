      ...
      <header className="h-16 md:h-14 bg-white backdrop-blur-md border-b border-slate-200 px-4 md:px-8 flex items-center justify-between sticky top-0 z-40">
        <div className="flex items-center gap-4 md:gap-6 flex-1 max-w-2xl">
          <div className="relative w-full max-w-md">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-2.5 border-none rounded-xl focus:ring-2 focus:ring-[#1A2332]/50 text-sm bg-slate-100 text-slate-900"
            />
          </div>
        </div>
        <div className="flex items-center gap-2 md:gap-4 ml-2">
          <button
            type="button"
            onClick={onNewTask}
            className="flex items-center gap-2 text-white px-4 md:px-5 py-2.5 rounded-xl font-bold text-sm shadow-sm hover:opacity-95 transition-opacity focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#1A2332]/80"
          ...
          <div className="relative hidden md:block" ref={profileMenuRef}>
            <button
              ...
              aria-haspopup="true"
            >
              <div className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-slate-200 flex items-center justify-center text-slate-700 font-semibold text-sm border-2 border-transparent hover:border-[#1A2332] transition-all">
                {userInitial}
              </div>
      ...
      <div className="p-4 md:pt-1 md:px-8 md:pb-8 grid grid-cols-12 gap-6">
        ...
        <section className="col-span-12 lg:col-span-4 space-y-6">
                ...
                {!searchQuery.trim() && (
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-2">
                    <button
                      type="button"
                      onClick={onNewTask}
                      className="px-4 py-2 rounded-lg text-sm font-semibold text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#1A2332]/80"
                      style={{ backgroundColor: PRIMARY }}
                    >
                ...
                return (
                  ...
                  >
                    <input
                      ...
                      className="task-checkbox mt-1 w-5 h-5 rounded border-slate-300 dark:border-slate-700 focus:ring-[#1A2332] accent-[#1A2332]"
                    />
          ...
          {topCategory && topCategory.total > 0 ? (
            <div className="p-5 rounded-2xl text-white bg-gradient-to-br from-[#1A2332] to-slate-800 border border-[#1A2332]/20">
        ...
        <section className="col-span-12 lg:col-span-5 space-y-6">
          ...
          <div className={`p-6 rounded-3xl border relative overflow-hidden ${dark ? 'bg-[#1A2332]/10 border-[#1A2332]/25' : 'bg-slate-50 border-slate-200'}`}>
            <div className="absolute -top-4 -right-4 w-24 h-24 bg-[#1A2332]/10 rounded-full blur-2xl" />
            <div className="flex items-center gap-3 mb-4 relative">
              <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-[#1A2332]/15">
