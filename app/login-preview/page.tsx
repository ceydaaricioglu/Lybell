...
export default function LoginPreview() {
  ...
  const handleEmailLogin = async () => {
    ...
    setTimeout(() => {
      setLoading(false);
      alert(isSignUp ? 'Account created! (Preview mode)' : 'Sign-in link sent! (Preview mode)');
    }, 1000);
  };
  ...
  const handleGoogleLogin = async () => {
    ...
    setTimeout(() => {
      setLoading(false);
      alert('Google sign-in (Preview mode)');
    }, 1000);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-400 via-emerald-500 to-teal-600 flex flex-col justify-center items-center px-6 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-emerald-50 text-lg">Manage your day, simply</p>
        </div>
        ...
        {/* Footer */}
        <p className="text-center text-emerald-50/80 text-sm">
